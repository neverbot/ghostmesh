      ...
      >
        ...
        <div class="py-1">
          ...
          >
            ...
            {{ $t('contextMenu.openConversation') }}
          </button>
          ...
          >
            ...
            {{
              prefs.isPreviewHidden(serverId, nick)
                ? `✓ ${$t('contextMenu.previewsHidden')}`
                : $t('contextMenu.hidePreviews')
            }}
          </button>
          ...
          >
            ...
            {{
              prefs.isUserBlocked(serverId, nick)
                ? `✓ ${$t('contextMenu.userBlocked')}`
                : $t('contextMenu.blockUser')
            }}
          </button>
        </div>
      </div>
